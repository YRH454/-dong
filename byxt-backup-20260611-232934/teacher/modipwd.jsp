...
<title>修改密码</title>
<style>
:root{--b:#1565C0;--bl:#1E88E5;--w:#fff;--d:#333}
*{margin:0;padding:0;box-sizing:border-box}
body{font-family:"PingFang SC","Hiragino Sans GB","Microsoft YaHei",sans-serif;background:#f4f6f9;color:var(--d);font-size:15px;padding:20px 14px}
h3{font-size:20px;color:var(--b);margin-bottom:18px}
.fcard{background:var(--w);border-radius:13px;padding:20px 16px;box-shadow:0 1px 6px rgba(0,0,0,.04)}
...
.fg input:focus{border-color:var(--bl);box-shadow:0 0 0 3px rgba(30,136,229,.08)}
...
<h3>🔑 修改密码</h3>
<div class="fcard">
<form id="form1" action="/byxt/teacher/modipwd" method="post">
