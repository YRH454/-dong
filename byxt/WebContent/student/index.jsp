...
%>
	...
	<div class="top2">
		...
		<div class="fr top-link">
			<span style="color:white">学号：${currentUser.id} 　姓名：${currentUser.mc}　　　选项：${currentUser.dp}　　　　　　</span> 
		</div>
	</div>
	...
	<div class="left">
		<div class="div1">
			<c:if test="${zt==1}">
           <div class="div2" onclick="openurl('/byxt/student/xt.jsp');">
				<div class="spgl"></div>
				选择题目
			</div>
			</c:if>
			<c:if test="${zt==0}">
           <div class="div2" onclick="openurl('/byxt/student/kt.jsp');">
				<div class="spgl"></div>
				查看题目
			</div>
			</c:if>
			
			<div class="div2" onclick="openurl('/byxt/student/xtjg.jsp');">
				<div class="spgl"></div>
				选题结果
			</div>
			
			<div class="div2" onclick="openurl('/byxt/student/modizl.jsp');">
				<div class="spgl"></div>
				 个人信息
			</div>	
			
			
		<div class="div2" onclick="openurl('/byxt/student/modipwd.jsp');">
					<div class="tcht"></div>
					修改密码
			</div>
			<a href="/byxt/logout">
	...
	<div class="right">
		<iframe id="rightFrame" name="rightFrame" width="100%" height="100%"
			...
			style="border: 0px solid #CCC; margin: 0; padding: 0;" src="/byxt/student/modizl.jsp"></iframe>
	</div>
