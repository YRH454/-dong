...
<body>
	...
	<div class="top2">
		...
		<div class="title" >
			<h3>毕业设计选题系统-root端</h3>
		</div>
		<div class="fr top-link">
			<span style="color:white">root：${currentUser.id}　　　</span>
		</div>
	</div>
	...
	<div class="left">
		<div class="div1">
           ...
           <div class="div2" onclick="openurl('/byxt/root/userAdmin.jsp');">
				<div class="spgl"></div>
				 &nbsp;&nbsp; admin管理
			</div>
			...
			<div class="div2" onclick="openurl('/byxt/root/modipwd.jsp');">					<div class="tcht"></div>
					修改密码
			 </div>
			<a href="/byxt/logout">
			<div class="div2">
