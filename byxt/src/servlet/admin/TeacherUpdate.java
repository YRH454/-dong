...
@WebServlet("/admin/teacher/update")
public class TeacherUpdate extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			    ...
			    teacher.setGh(request.getParameter("gh"));
			    teacher.setXm(request.getParameter("xm"));
			    ...
			    teacher.setShangxian(Integer.parseInt(request.getParameter("shangxian")));
			    teacher.setAdminid(adminid);
				teacherDao.update_a(teacher);
