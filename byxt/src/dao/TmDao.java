...
public class TmDao {
	...
	public void exportToExcel(File excelPath,String condition) throws Exception{
		...
		try {
		    ...
		    rs=ps.executeQuery();
			 ...
			 String[] titles={"教师工号","教师姓名","题目","题目备注","学生学号","学生姓名","专业","班级"};
	...
	public void exportToExcel2(File excelPath,String condition) throws Exception{
		...
		try {
		    ...
		    rs=ps.executeQuery();
			 wwb=Workbook.createWorkbook(excelPath);
			 ws=wwb.createSheet("sheet1",0);
			 String[] titles={"教师工号","教师姓名","题目","题目备注","学生学号","学生姓名","专业","班级","email","phone","qq"};
			 int columnCount=titles.length;
			 for(int i=0;i<columnCount;i++){
	...
	public void update2(String xh,String xm,String zy,String bj,String adminid) throws Exception {//学生修改资料后，题目需要再更新下
		Connection conn = null;
		PreparedStatement ps = null;
		try {
			conn = JdbcUtil.getConnection();
	...
	public void update3(String gh,String txm,String adminid) throws Exception {//教师修改资料后，题目需要再更新下
		Connection conn = null;
		PreparedStatement ps = null;
		try {
			conn = JdbcUtil.getConnection();
	...
	public void qcjl(String sno,String adminid) throws Exception {//清除题目记录
		Connection conn = null;
		PreparedStatement ps = null;
		try {
			conn = JdbcUtil.getConnection();
