...
const menus=[{path:'/teacher/add',icon:'✏️',label:'教师出题'},{path:'/teacher/batch',icon:'📦',label:'批量出题'},{path:'/teacher/my-topics',icon:'📋',label:'选题结果'},{path:'/teacher/profile',icon:'👤',label:'个人信息'},{path:'/teacher/password',icon:'🔑',label:'修改密码'}]
