...
const menus=[{path:'/student/topics',icon:'📝',label:'选择题目'},{path:'/student/favorites',icon:'⭐',label:'我的收藏'},{path:'/student/my-result',icon:'📋',label:'选题结果'},{path:'/student/profile',icon:'👤',label:'个人信息'},{path:'/student/password',icon:'🔑',label:'修改密码'}]
