<template>
<div class="app-shell">
  <van-nav-bar title="选题系统-管理端" left-text="菜单" @click-left="showSide=!showSide" fixed placeholder>
    <template #right><span style="font-size:13px;color:#888">{{ user?.dp }}</span></template>
  </van-nav-bar>
  <div class="body-wrap">
